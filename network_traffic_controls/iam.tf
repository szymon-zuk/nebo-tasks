...
resource "aws_iam_role" "lab_instance" {
  name               = "${local.aws_name_prefix}-netdemo-ec2-role"
...
resource "aws_iam_instance_profile" "lab_instance" {
  name = "${local.aws_name_prefix}-netdemo-instance-profile"
  role = aws_iam_role.lab_instance.name
...
resource "aws_iam_role" "flow_logs" {
  name               = "${local.aws_name_prefix}-netdemo-flowlogs-role"
...
resource "aws_iam_role_policy" "flow_logs_publish" {
  name = "${local.aws_name_prefix}-netdemo-flowlogs-publish"
